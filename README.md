...
![version-badge](https://img.shields.io/static/v1?label=version&message=0.1.4&color=blue)
...
```bash
yarn add --dev ssh://git@gitlab.com:via-profit-services/eslint-config.git#semver:^0.1.4
```
